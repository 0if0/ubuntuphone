...
UBUNTU_TRANSLATION_DOMAIN="test.if"
...
aptest.commands = bash $$PWD/test/tests/autopilot/run
aptest.depends  = sub-test

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/test/tests/unit 
unittest.depends  = sub-test
